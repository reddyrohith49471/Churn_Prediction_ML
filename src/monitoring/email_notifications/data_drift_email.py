...
class DataDriftEmail:
    ...
    def send_drift_alert(self, subject: str, drift_result: Dict, attachments: List[Path] | None = None):
        ...
        body = self._build_email_body(drift_result)
    ...
    @staticmethod
    def _build_email_body(drift_status: Dict) -> str:
